    ...
    if (result.code === '404') {
        ...
        for (let i = 0; i < result.message.length; i++) {
            ...
            getValori(request).then(resultat => {
                ...
                var button = document.createElement('div');
                button.className = 'button_container';
                var startParty = document.createElement('button');
                startParty.className = 'btn';
                ...
                if (datetime >= dataparty) {
                    startParty.style.display = "block"
                } else {
                    startParty.style.display = "none"
                }
                ...
                startParty.appendChild(update_span);
                button.appendChild(startParty);
